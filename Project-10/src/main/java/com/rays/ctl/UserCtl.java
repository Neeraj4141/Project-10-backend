 ...
 * profile updates, password changes, role preloading,
...
public class UserCtl extends BaseCtl<UserForm, UserDTO, UserServiceInt> {
	...
	/**
	 * Loads role data for dropdown lists.
	 *
	 * @return ORSResponse containing the list of roles
	 */
	@GetMapping("preload")
	 ...
	 *
	 * @param form           contains login ID, old password, and new password
	 * @param bindingResult  validation result
	 ...
	 * @return ORSResponse containing the uploaded image ID
	 * @throws RuntimeException if the uploaded file is empty
	 */
